    Shader "Custom/Pickups-Lit-Default"
{
    Properties
    {
        ...
        [Toggle(USE_SCENE_LIGHTING)] _UseSceneLighting("Use Scene Lighting", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/Include/ItemCombinedShapeLightShared.hlsl"
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                half visionMask = 0;
                #if USE_SHAPE_LIGHT_TYPE_3
                visionMask = SAMPLE_TEXTURE2D(_ShapeLightTexture3, sampler_ShapeLightTexture3, i.lightingUV).g;
                #endif
                half4 finalColor = mainTex;
                half4 tempMask = 0;
                if (visionMask >= 0.01)
                {
                    tempMask = clamp(visionMask + 0.5, 0, 1);
                }
                else
                {
                    tempMask = 0;
