...
half4 CombinedShapeLightShared(in SurfaceData2D surfaceData, in InputData2D inputData)
{
    ...
    half4 finalAdditive = shapeLight0Additive + shapeLight1Additive + shapeLight2Additive;
    ...
    half4 visionMask = SAMPLE_TEXTURE2D(_ShapeLightTexture3, sampler_ShapeLightTexture3, inputData.lightingUV);
    #endif
