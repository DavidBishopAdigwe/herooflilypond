...
namespace Managers
{
    ...
    /// </summary>
    public abstract class ScriptableObjectSingleton<T> : ScriptableObject where T: ScriptableObject // Might swap to unity's variant? But i think this performs it's purpose
    {
